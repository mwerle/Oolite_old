 ...
 *     Program: hhead
 *
 * Description: call http_request to process a HEAD request over http
 *
 ***************************************************************************
 *
 * hhead.c
...
int main( int argc, char** argv )
{
    ...
    if( argc < 2 )
    {
        ...
        fprintf( stderr, "    hhead http://localhost/ ./index.html\n" );
        fprintf( stderr, "    hhead http://www.SoftOrchestra.com/images/music.png ./music.png\n" );
        fprintf( stderr, "    hhead http://localhost/ ./local.html \"If-Modified-Since: Mon, 18 Sep 2000 16:00:00 GMT\"\n" );
        fprintf( stderr, "    hhead http://localhost/ ./local.html \"If-Match: \\\"xxx\\\"\\nIf-Modified-Since: Mon, 18 Sep 2000 16:00:00 GMT\"\n\n" );
        exit( 1 );
    }
    ...
    hResponse = http_request( argv[1], &hExtra, kHMethodHead, HFLAG_NONE );
    ...
    {
        fprintf( stderr, "Header for request follows:\n%s\n", hResponse.pData );
