...
unsigned char* generatePlanet(int a, int b, int c, int d, int e, int f)
{
  ...
  renderer.AddGradientPoint (-1.0000, utils::Color (  0,   0, 128, 0)); // deeps
  renderer.AddGradientPoint (-0.2500, utils::Color (  0,   0, 255, 0)); // shallow
  ...
  renderer.AddGradientPoint ( 0.9500, utils::Color (128, 128, 128, 255)); // rock
...
unsigned char* generateClouds(int a, int b, int c, int d, int e, int f)
{
	...
	renderer.ClearGradient ();
	renderer.AddGradientPoint (-1.00, utils::Color (0, 0, 255,   0));
	renderer.AddGradientPoint (-0.50, utils::Color (0, 255, 0,   0));
